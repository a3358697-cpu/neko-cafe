...
const menuGroups = [
  ...
  { title: '周邊商品・現場拍攝', icon: MessageCircle, note: '取照方式：於 Discord 群內領取照片。若不希望照片公開於群內，請提前告知攝影的店員。', items: [['貓咪合影', '', '300,000 Gil'], ['貓咪合影簽名', '簽名僅部分貓咪有提供', '500,000 Gil']] },
]
