...
const menuGroups = [
  ...
  { title: '醫護站服務', icon: Syringe, items: [['傷口包紮', '被貓咪抓咬弄傷了嗎？來這裡讓我們細心包紮，順便附上一句安慰。', '5w'], ['喵喵健康針', '可愛版健康針劑，守護你今晚不生病，還會附贈一張逗趣貼紙。｜購買後獲得一張貓爪信物卡，交給任一在場貓咪即可兌換', '10w']] },
  { title: '周邊商品・現場拍攝', icon: MessageCircle, note: '取照方式：於 Discord 群內領取照片。若不希望照片公開於群內，請提前告知攝影的店員。', items: [['貓咪合影', '', '30w'], ['貓咪合影簽名', '簽名僅部分貓咪有提供', '50w']] },
]

const personalityDetails = [
  ['全部', '查看店內全部 12 隻貓咪，讓緣分自己決定。'],
  ['撒嬌黏人', '喜歡窩在你手邊，摸久了會發出呼嚕聲，多待在喝茶區。'],
  ['傲嬌', '嘴上嫌你煩，尾巴卻誠實地繞著你的手，偶爾會輕輕咬一口。'],
  ['高冷', '不太主動，但願意讓你靜靜坐在旁邊，是需要耐心的類型。'],
  ['貪吃', '看到貓條就衝過來，是最容易被貓用品吸引的類型。'],
  ['搗蛋', '偶爾會抓一下、咬一下純屬玩鬧，多待在玩樂區，互動最有隨機感。'],
]
